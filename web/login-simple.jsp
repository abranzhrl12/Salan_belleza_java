            ...
            <div class="col-md-6 col-lg-5">
                <div class="card login-card border-0">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="${pageContext.request.contextPath}/login-simple" method="post" id="loginForm">
                            <div class="mb-3">
                        ...
                        <div class="text-center">
                            <h6 class="text-primary">Credenciales de Prueba:</h6>
    ...
    <script>
        ...
        document.getElementById('loginForm').addEventListener('submit', function(e) {
            ...
            if (username === 'admin' && password === 'admin123') {
                ...
                window.location.href = '${pageContext.request.contextPath}/admin/dashboard-simple.jsp';
            } else {
                e.preventDefault();
