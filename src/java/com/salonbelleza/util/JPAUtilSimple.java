...
/**
 * Clase utilitaria simplificada para manejar el EntityManager de JPA
 * Versión sin inicialización estática para evitar errores
 * @author Sistema Salon Belleza
 */
public class JPAUtilSimple {
    ...
    public static EntityManager getEntityManager() {
        ...
        if (entityManagerFactory == null) {
            synchronized (JPAUtilSimple.class) {
                if (entityManagerFactory == null) {
                    try {
